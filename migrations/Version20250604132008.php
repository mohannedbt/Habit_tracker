 ...
 */
final class Version20250604132008 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE INDEX IDX_45114028E7AEB3B2 ON daily_report (habit_id)
        SQL);
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            DROP INDEX IDX_45114028E7AEB3B2 ON daily_report
        SQL);
        $this->addSql(<<<'SQL'
